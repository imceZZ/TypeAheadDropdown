...
var _interopRequireDefault = require("/Users/neimelezi/Desktop/testProjects/reactWEB/TypeAheadDropdown/node_modules/babel-preset-react-app/node_modules/@babel/runtime/helpers/interopRequireDefault");
...
var _jsxFileName = "/Users/neimelezi/Desktop/testProjects/reactWEB/TypeAheadDropdown/src/TypeAheadDropdown/index.js";
...
class TypeAheadDropdown extends _react.default.Component {
  constructor(props) {
    ...
    this.state = {
      data: typeof this.props.data != "undefined" ? this.props.data : _students.default,
  ...
  render() {
    ...
    }), displayTable ? /*#__PURE__*/_react.default.createElement("div", {
      className: "searchDiv",
      style: {
    ...
    }, firstButton), /*#__PURE__*/_react.default.createElement("button", {
      className: "btnNext",
